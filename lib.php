...
/**
 * This file contains the moodle hooks for the submission gradeqr plugin
 *
...
function assignsubmission_gradeqr_pluginfile($course,
                                                $cm,
                                                context $context,
                                                $filearea,
                                                $args,
    ...
    $fullpath = "/{$context->id}/assignsubmission_gradeqr/$filearea/$itemid/$relativepath";
